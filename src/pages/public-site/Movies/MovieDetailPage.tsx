      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="aspect-[2/3] w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-zinc-900">
              <img
                src={movie.posterUrl}
                alt={movie.title}
            ...
            {movie.trailerUrl && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/10 text-white text-xs font-bold uppercase tracking-wider transition-colors"
              >
          ...
          <div className="space-y-4">
            {showtimes.length > 0 ? (
              showtimes.map((st) => (
                <div
                  key={st.id}
                  className="p-5 rounded-2xl bg-[#161619] border border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:border-white/20 transition-all"
                >
